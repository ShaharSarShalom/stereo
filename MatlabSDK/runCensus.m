...
for im_num = 1:15
    ...
    pfmwrite(single(DisparityMap{1}), ['~/MiddEval3/',imgset,imgsize,'/',image_names{im_num},'/disp0',methodname,'.pfm']);
    pfmwrite(single(DisparityMap_sparse{1}), ['~/MiddEval3/',imgset,imgsize,'/',image_names{im_num},'/disp0',methodname,'_s.pfm']);
