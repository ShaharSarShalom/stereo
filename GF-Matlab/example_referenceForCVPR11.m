function output = example_referenceForCVPR11(Il,Ir,numDisp,r,eps,thresColor,thresGrad,gamma,threshBorder,gamma_c,gamma_d,r_median,UseParallelToolbox)
...
% elseif (testimage==2)
%     Il = double(imread('./img_stereo/teddy_left.ppm')) / 255;
%     Ir = double(imread('./img_stereo/teddy_right.ppm')) / 255;
